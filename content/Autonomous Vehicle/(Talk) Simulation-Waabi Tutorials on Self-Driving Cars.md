---
title: (Talk) Simulation-Waabi Tutorials on Self-Driving Cars
created: 2025-11-10 19:29
modified: 2025-11-23 13:41
tags:
  - AV
  - Talk
keywords:
...
# (Talk) Simulation-Waabi Tutorials on Self-Driving Cars
...
- Waabi는 모듈식 폐루프 시뮬레이션을 제안하고 월드 기반 시뮬레이션과의 차이를 다음과 같이 정리한다.

| 특징          | 모듈식 폐루프 시뮬레이션                                  | 원드 모델 기반 시뮬레이션                        |
| ------------- | --------------------------------------------------------- | ------------------------------------------------ |
| 구조          | 시나리오, 행위자, 센서, 차량 동역학을 분리                | 세계의 물리법칙과 외형을 암묵적으로 인코딩       |
| 제어가능성    | 정확하고 정밀한 제어 가능                                 | 고수준의 의미론적인 제어 가능                    |
| 현실성/안전성 | 높은 현실성을 보장하며 매개변수 공간에서 성능 특성화 가능 | 분포 외 상황에서 비현실적인 예측 가능            |
| 정리          | 시스템 성능을 이해하고 평가하기 용                        | 다양성을 확보하고 현실성이 높은 데이터 생성 가능 |
